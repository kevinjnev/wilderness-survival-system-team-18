...
public class Balanced extends Brain {
    ...
    * General Plan:
    * 
    * If water or food is above 50%, ask vision for gold. If no gold in sight then ask for the farthest tile toward end goal it can see unless a trader is in sight.
    *
    ...
    * 
    * If strength is less than 30%, rest until strength is full or food or water is < 30% full.
    * When strength is less than 30% and food or water is below 30% do not rest until that resource is above 30% full.
    * 
    * When on a repeatable resource tile, stay until stamina and resource are 75% full or other resource is below 30% full.
    * 
    * 
    * Trader behavior:
    * 
    */
    ...
    public void makeMove(Player player) {
        ...
        //logic for normal stamina.
            ...
            if(player.getWater() < 50 || player.getFood() < 50) {
                if(player.getWater() <= player.getFood()) {
                    pathToFollow = waterPriorityPath(player);
                }
                else {
